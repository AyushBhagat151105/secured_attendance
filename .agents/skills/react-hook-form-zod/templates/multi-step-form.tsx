        ...
        {currentStep === 2 && (
          <div className="space-y-4">
            ...
            <div>
              ...
              <input {...register("street")} className="w-full px-3 py-2 border rounded-md" />
              {errors.street && (
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input {...register("city")} className="w-full px-3 py-2 border rounded-md" />
                {errors.city && <span className="text-sm text-red-600">{errors.city.message}</span>}
              </div>

              <div>
                <label className="block text-sm font-medium mb-1">State *</label>
                <input {...register("state")} className="w-full px-3 py-2 border rounded-md" />
                {errors.state && (

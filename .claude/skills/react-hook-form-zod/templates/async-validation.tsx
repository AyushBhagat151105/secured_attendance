  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-md mx-auto">
      ...
      <div>
        ...
        />
        {isValidating && (
          <span className="text-sm text-blue-600 mt-1 block">Checking availability...</span>
        )}
        {errors.username && (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 max-w-md mx-auto">
      ...
      <div>
        ...
        {!errors.username && username.length >= 3 && !isCheckingUsername && (
          <span className="text-sm text-green-600 mt-1 block">Username is available ✓</span>
        )}
      </div>
      ...
      <div>
        ...
        {!errors.email && email && !isCheckingEmail && (
          <span className="text-sm text-green-600 mt-1 block">Email is available ✓</span>
        )}
      </div>

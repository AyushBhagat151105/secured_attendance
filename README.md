...
<p align="center">
  ...
  <a href="https://github.com/ayushbhagat151105/secured_attendance"><img src="https://img.shields.io/badge/tests-147%20passing-brightgreen.svg" alt="Tests" /></a>
...
- **Zero-DB E2E Test Suite**: Architected an in-memory database and Redis simulation harness running in ~500ms with zero live-database risk, maintaining 147 passing tests across all full attendance lifecycles, route guards, and admin bulk CSV imports.
...
# 2. Run unit and isolated E2E tests (147 tests, ~500ms execution)
bun test

...
function MapTileLayer({
  ...
  const DEFAULT_DARK_URL = "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png";
  ...
  return <TileLayer url={resolvedUrl} attribution={resolvedAttribution} {...props} />;
}
...
function MapCircle({ className, ...props }: CircleProps & { ref?: Ref<LCircle> }) {
  return (
    <Circle className={cn("fill-foreground stroke-foreground stroke-2", className)} {...props} />
  );
}
...
function MapPolyline({ className, ...props }: PolylineProps & { ref?: Ref<LPolyline> }) {
  return (
    <Polyline className={cn("fill-foreground stroke-foreground stroke-2", className)} {...props} />
  );
}

function MapPolygon({ className, ...props }: PolygonProps & { ref?: Ref<LPolygon> }) {
  return (
    <Polygon className={cn("fill-foreground stroke-foreground stroke-2", className)} {...props} />
  );
}

function MapRectangle({ className, ...props }: RectangleProps & { ref?: Ref<LRectangle> }) {
  return (
    <Rectangle className={cn("fill-foreground stroke-foreground stroke-2", className)} {...props} />
  );
}

function MapPopup({ className, ...props }: Omit<PopupProps, "content"> & { ref?: Ref<LPopup> }) {
  return (
    <Popup
      className={cn(

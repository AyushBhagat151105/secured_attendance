...
function DownloadAppPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[calc(100vh-100px)] max-w-md mx-auto text-center p-6 space-y-6">
      ...
      <h1 className="text-3xl font-bold tracking-tight text-foreground">Mobile App Required</h1>
      <p className="text-muted-foreground text-lg">
        The web dashboard is for administrators and teachers. As a student, please download the
        mobile app to scan attendance QR codes and view your records.
      </p>
